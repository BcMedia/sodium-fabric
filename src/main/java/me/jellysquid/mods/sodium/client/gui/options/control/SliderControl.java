    ...
    private static class Button extends ControlElement<Integer> {
        ...
        public void render(MatrixStack matrixStack, int mouseX, int mouseY, float delta) {
            ...
            if (this.option.isAvailable() && this.hovered) {
                this.renderSlider(matrixStack, mouseX, mouseY, delta);
            } else {
                this.renderStandaloneValue(matrixStack, mouseX, mouseY, delta);
            }
        }

        private void renderStandaloneValue(MatrixStack matrixStack, int mouseX, int mouseY, float delta) {
        ...
        private void renderSlider(MatrixStack matrixStack, int mouseX, int mouseY, float delta) {
            int sliderX = this.sliderBounds.getX();
            int sliderY = this.sliderBounds.getY();
            int sliderWidth = this.sliderBounds.getWidth();
            int sliderHeight = this.sliderBounds.getHeight();
